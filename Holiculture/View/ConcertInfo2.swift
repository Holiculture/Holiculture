...
//  Holiculture
//
//  Created by 민지은 on 2023/09/23.
//

import SwiftUI

struct ConcertInfo2: View {
                ...
                ScrollView{
                    ...
                    ScrollView(.horizontal){
                        HStack{
                            ...
                            ForEach(concert.subImgs, id: \.self) { img in
                                Rectangle()
                                    .foregroundColor(.clear)
                                    .frame(width: 255, height: 317)
                                    .background(
                    ...
                    concertInfoCell(option: "공연장소", optionData: "\(concert.location) (\(concert.address))")
...
struct ConcertInfo2_Previews: PreviewProvider {
    static var previews: some View {
        ConcertInfo2(concert: ConcertDataModel(_id: 748, title: "제6회 1번출구 연극제", startDate: "20230920", endDate: "20231029", titleImg: "https://www.kopis.or.kr/upload/pfmPoster/PF_PF224355_230822_105515.gif", location: "한성아트홀(구. 인켈아트홀)", cate: "연극", address: "서울특별시 종로구 창경궁로 254 (명륜2가)", summary: " ", cast: "모형주, 안병준, 이혜림, 권혁재, 노윤서, 이종민, 황선영 등", crew: "정범철, 박혜선, 최해주 등", runtime: "1시간 30분", age: "만 15세 이상", producer: " ", price: "전석 30,000원", time: "수요일 ~ 금요일(19:30), 토요일 ~ 일요일(15:00)", openrun: "N", subImgs: ["https://www.kopis.or.kr/upload/pfmIntroImage/PF_PF224355_230822_1055150.jpg",
