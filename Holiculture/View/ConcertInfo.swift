...
//                    concertInfoCell(option: "공연장소", optionData: "\(concert.location)")
                    ...
                    NavigationLink(destination : MakeTicketView(concert: concert.title, date: $date, address: concert.address, img: concert.titleImg, tickets: $tickets), isActive: $isActive){
                        Button(action: {
                            isActive = true
                            print("등록하기 버튼 클릭")
                        }) {
